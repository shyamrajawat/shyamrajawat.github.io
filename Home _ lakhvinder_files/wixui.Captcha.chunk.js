...
exports.default = __webpack_require__.stylable.create(
  ...
  "",
  7,
  /*! ./components/Captcha/Captcha.st.css */ 356
);

exports.default.$skin = {"params":{},"paramsDefaults":{}};
exports.default.$skin.$render = function render_css($id, $params, $functions) {
  return "\n" + $id + ".Captcha3262913751--root{position: relative}\n" + $id + " .Captcha3262913751--loaderWrapper{}\n" + $id + " .Captcha3262913751--captcha{}\n" + $id + ".Captcha3262913751--root[data-captcha3262913751-loaded] .Captcha3262913751--captcha{display: block}\n" + $id + ".Captcha3262913751--root[data-captcha3262913751-loaded] .Captcha3262913751--loaderWrapper{display: none}\n" + $id + ".Captcha3262913751--root .Captcha3262913751--captcha{display: none}\n" + $id + ".Captcha3262913751--root .Captcha3262913751--requiredField{position: absolute;opacity: 0.0;bottom: 0;left: 0;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none}\n" + $id + ".Captcha217700995--root{}\n" + $id + ".Captcha217700995--root .Captcha3262913751--captcha{transform: scale(0.77);transform-origin: top left}\n";
};
...
var _Captcha = __webpack_require__(/*! ./Captcha */ 655);

var _CaptchaSt = __webpack_require__(/*! ./Captcha.st.css */ 356);
...
var _captcha = __webpack_require__(/*! wix-ui-core/captcha */ 656);
...
var Captcha = exports.Captcha = function (_React$Component) {
  ...
  _createClass(Captcha, [{
    ...
    value: function tranlateLangCodeToCaptchaLang(siteLangCode) {
      ...
      if (siteLangCode === 'zh') {
        return _captcha.CaptchaLang.ChineseTraditional;
      }
...
var santaCaptcha = exports.santaCaptcha = (0, _createReactClass2.default)({
  ...
  propTypes: {
    ...
    languageCode: _santaComponents.santaTypesDefinitions.RendererModel.languageCode
  },
  ...
  detectCaptchaLanguage: function detectCaptchaLanguage() {
    if (this.props.isMLEnabled) {
      return this.props.currentLanguage.code;
    } else if (this.props.languageCode) {
      return this.props.languageCode;
    } else {
      return _captcha.CaptchaLang.EnglishUS.toString();
    }
  },
  getSkinProperties: function getSkinProperties() {
    ...
    var captchaProps = _lodash2.default.assign({}, this.props.compData, this.props.compProp, {
      ...
      onVerify: function onVerify(token) {
        ...
        _this3.handleAction(ACTION_TYPES.ON_VERIFY);
      },
      onExpire: function onExpire() {
        _this3.updateData({ token: undefined });
        _this3.handleAction(ACTION_TYPES.ON_TIMEOUT);
      },
      onError: function onError() {
        _this3.handleAction(ACTION_TYPES.ON_ERROR);
      },
...
module.exports = __webpack_require__(/*! ./dist/src/components/captcha */ 657);
...
Object.defineProperty(exports, "__esModule", { value: true });
var Captcha_1 = __webpack_require__(/*! ./Captcha */ 658);
exports.Captcha = Captcha_1.Captcha;
var types_1 = __webpack_require__(/*! ./types */ 661);
...
var React = __webpack_require__(/*! react */ 0);
var Reaptcha = __webpack_require__(/*! reaptcha */ 659);
var Captcha_st_css_1 = __webpack_require__(/*! ./Captcha.st.css */ 660);
/**
 * Captcha
 */
...
exports.default = __webpack_require__.stylable.create(
  "root",
  "Captcha3262913751",
  {"root":"Captcha3262913751--root","loaderWrapper":"Captcha3262913751--loaderWrapper","captcha":"Captcha3262913751--captcha","requiredField":"Captcha3262913751--requiredField"},
  "",
  1,
  /*! ../node_modules/wix-ui-core/dist/src/components/captcha/Captcha.st.css */ 660
);
